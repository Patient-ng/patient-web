     ...
     <div className="w-full px-4 pb-5 pt-10 md:pt-12">
        ...
        <h1 className="text-2xl text-center  font-bold tracking-tight sm:text-2xl md:text-3xl lg:text-5xl mb-5">
         ...
         <div className='flex flex-col md:flex-row md:items-center md:space-x-2'>
          <FormInput label="First Nmae" inputClassName="w-full" value={formData.firstName} onChange={(e) => setFormData({ ...formData, firstName: e.target.value })}/>
          <FormInput label="Last Nmae" inputClassName="w-full" value={formData.lastName} onChange={(e) => setFormData({ ...formData, lastName: e.target.value })} />
         </div>
